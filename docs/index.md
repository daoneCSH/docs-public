...
DADP 공식 문서 사이트는 고객사 운영자와 연동 개발자가 현재 구현된 제품 표면을 기준으로 DADP를 이해하고 배포하고 운영할 수 있도록 정리한 공개 문서 집합이다. 내부 작업 기록, 임시 조사 메모, 개발 중간 산출물은 포함하지 않는다.
...
3. [Platform Architecture](architecture/platform-architecture.md)
4. [Module Overview](modules/module-overview.md)
5. [Integration Overview](integrations/integration-overview.md)
6. [API Overview](api/api-overview.md)
